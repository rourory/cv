    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center gap-14 z-30 ">
        ...
        >
          ...
          raise English to a confident <b>C1+/C2</b> level and start learning
          another foreign language, for example, german.
        </InfoBlock>
      </div>
    </motion.section>
  );
...
//C# использую преимущественно в разработке десктопных приложений. Знаком с .NET, LINQ, async/await, а также современными возможностями языка. Работал с WPF, ASP.NET и консольными утилитами. В проектах применяю принципы SOLID, использую DI и логирование через Serilog. Удобен как для быстрой разработки, так и для сложных архитектурных решений.
