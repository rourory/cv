...
const PortfolioProjectBlock: React.FC<IPortfolioProjectBlock> = ({
  ...
  return (
    <motion.div
      ...
      className="z-20 bg-slate-800 rounded-lg px-3 sm:px-10 pb-5 pt-5 pointer-events-auto shadow-[1px_0px_15px_rgba(255,255,255,0.1) max-w-[750px] mx-auto"
    >
      <div className="sm:hover:scale-[103%] transition-all duration-200">
        <div>
